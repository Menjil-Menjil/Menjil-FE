  ...
  return(
    <LoginModalBox>
      ...
      <LoginModalContent onClick={(e) => e.stopPropagation()}>
        <button className="closeBtn" onClick={closeModal}><Image src={closeIc} alt="닫기"/></button>
        <div className="contentBox">
          <div className="copy">나를 너무 잘 아는<br/>멘토를 만나는 곳</div>
          <button className="google"><Image src={googleIc} alt="구글" width={18} height={18}/>구글 로그인</button>
          <button className="kakao"><Image src={kakaoIc} alt="카카오" width={18} height={18}/>카카오 로그인</button>
